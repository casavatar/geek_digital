...
import cvPdf from '@/assets/My Resume EN.pdf'
...
const personalInfo = ref<PersonalInfo>({
  ...
  avatar: profileImage,
  tagline:
    'Building innovative digital solutions that make a difference. Passionate about creating user-centered applications with modern technologies.',
...
const projects = ref<Project[]>([
  ...
  },
  {
    ...
    description:
      'A responsive weather dashboard with location-based forecasts, interactive maps, and historical data visualization.',
...
export function usePortfolioData() {
  ...
  const getProjectsByTechnology = (technology: string) => {
    return projects.value.filter((p) =>
      p.technologies.some((tech) => tech.toLowerCase().includes(technology.toLowerCase())),
    )
  }
