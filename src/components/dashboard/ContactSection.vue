<template>
  <div class="dashboard-card p-8">
    ...
    <div class="text-center mb-12 py-4">
      <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-6 pb-6">
        Let's Work Together
      </h2>
      <p class="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
        Ready to transform your data into actionable insights? I'd love to hear about your project
      ...
      <div class="space-y-8 py-6">
        <div>
          ...
          <div class="space-y-4 py-4">
            ...
            >
              <div
                class="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-200"
              >
                <svg
            ...
            >
              <div
                class="w-12 h-12 bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-200"
              >
                <svg
              ...
              <div class="py-1">
                <h4
                  class="font-semibold text-gray-900 dark:text-white group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors duration-200"
                >
                  GitHub
                </h4>
                <p class="text-sm text-gray-600 dark:text-gray-400">View my code and projects</p>
              </div>
            </a>
          </div>
        </div>
        ...
        >
          <div class="flex items-start space-x-3">
            ...
            <div class="py-1">
              <h4 class="font-semibold text-green-900 dark:text-green-200 mb-1">Quick Response</h4>
              <p class="text-sm text-green-700 dark:text-green-300">
                I typically respond to messages within 24 hours. For urgent projects, feel free to
